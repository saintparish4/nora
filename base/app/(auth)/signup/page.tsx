    ...
    <div className="min-h-screen bg-[var(--bg-color)] text-[var(--ink-color)] font-sans overflow-x-hidden relative">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-[2]">
        ...
        <section className="min-h-[calc(100vh-120px)] flex items-center justify-center py-10 relative">
          ...
          >
            <div className="mb-10">
              <h1 className="font-serif text-[2.5rem] font-normal tracking-[-0.02em] mb-2">Welcome</h1>
              <p className="text-[0.95rem] opacity-60">Create your account to get started.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-left mb-6">
                <label htmlFor="confirmPassword" className="block text-[0.7rem] uppercase tracking-[0.08em] font-semibold mb-2 opacity-70">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"

...
- **Services** (`app/services/`): `Appointments::SlotGeneratorService`, `Notifications::NotificationService`, `Providers::ProviderMatchingService`, `Triage::SymptomAnalyzerService`, `Triage::ConversationSufficiencyService`
